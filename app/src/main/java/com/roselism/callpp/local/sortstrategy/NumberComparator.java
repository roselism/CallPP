 ...
 * @描述 根据电话号码进行排序
 */
public class NumberComparator implements Comparator<ContactInfo> {
     ...
     * @param left        最左边
     * @param right       最右边
     * @param contactInfo 关键字
     */
    @Deprecated
    public static int parttion(List<ContactInfo> infos, int left, int right,
